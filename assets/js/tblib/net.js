...
$(function () {
    /*if (window.TBI.Loader && window.loader instanceof TBI.Loader) {
        loader.addTask(executeHTMLIncludes(TBI.Files.HTMLIncludesManifest), null, "HTMLIncludes");
        loader.addTask(executeFontLoading(), 5000, "Fonts", ["HTMLIncludes"]);
    }*/
});
